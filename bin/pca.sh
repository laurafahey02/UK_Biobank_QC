# This and pca_maha.R were run prior to nf pipeline.
...
#    ukb_snp_qc.txt (UKB supplied)
#    ukb_122merged.bed; ukb_122merged.bim; ukb_122merged.fam (UKB directly genotpyed chromosomes 1-22 merged)
